...
namespace Exercises
{
    public class Any
    {
        ...
        {
            // check if any pet has Weight over 2 and type is cat
            return pets.Any(pet => pet.Weight > 2.0f && pet.PetType == PetType.Cat);
        }
        ...
        {
            // conditions
            // first character is not lowercase
            // name is greater than 2 characters
